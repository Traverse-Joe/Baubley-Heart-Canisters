      ...
      while(true) {
         ...
         while(true) {
            ...
            if (!(minVolume <= 0.0F)) {
               ...
               vec3d = new Vec3d(serverplayerentity.func_226277_ct_() + d1 / d5 * 2.0D, serverplayerentity.func_226278_cu_() + d2 / d5 * 2.0D, serverplayerentity.func_226281_cx_() + d3 / d5 * 2.0D);
               f = minVolume;
               break;
            }
         }
