...
public class ContainerPendant extends Container {
    ...
    public ContainerPendant(ItemStack pendant,  InventoryPlayer playerInventory,  EnumHand hand) {
        ...
        int heldSlot = playerInventory.getSlotFor(playerInventory.player.getHeldItemMainhand());
        ...
        addSlotToContainer(new StaticSlot(itemHandler, heldSlot, 8 + heldSlot * 18, 142));
    }
    ...
    private static class StaticSlot extends SlotItemHandler {

        public StaticSlot(IItemHandler itemHandler, int index, int xPosition, int yPosition) {
            super(itemHandler, index, xPosition, yPosition);
        }
