...
public class ItemHeart extends BaseItem {
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        if (Screen.hasShiftDown()) {
            ...
            tooltipComponents.add(Component.translatable("tooltip.bhc.heart_drops").withStyle(ChatFormatting.GOLD));
            ...
            for (Map.Entry<String, Double> entry : entries.entrySet()) {
                ...
                tooltipComponents.add(Component.translatable("tooltip.bhc.drop_info", entityDisplayName, percentage).withStyle(ChatFormatting.GRAY));
            }
        } else {
            // Show hint to press Shift for more info
            tooltipComponents.add(Component.translatable("tooltip.bhc.hold_shift_for_drops").withStyle(ChatFormatting.GRAY, ChatFormatting.ITALIC));
        }
    }
