...
public class BHCRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput recipeOutput) {
        ...
        //Wither Bones
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RegistryHandler.WITHER_BONE.get(),6).requires(Tags.Items.BONES).requires(Tags.Items.BONES).requires(Tags.Items.BONES).requires(Items.WITHER_SKELETON_SKULL).unlockedBy("has_heart", has(RegistryHandler.RED_HEART.get())).group(BaubleyHeartCanisters.id("wither_bone").toString()).save(recipeOutput, BaubleyHeartCanisters.id("wither_bone"));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.BONE_MEAL, 6).requires(RegistryHandler.WITHER_BONE.get()).unlockedBy("has_wither_bone", has(RegistryHandler.WITHER_BONE.get())).group(BaubleyHeartCanisters.id("wither_bone_to_bonemeal").toString()).save(recipeOutput, BaubleyHeartCanisters.id("wither_bone_to_bonemeal"));
