...
public enum ShoreLayer implements ICastleTransformer {
   ...
   public int apply(INoiseRandom context, int north, int west, int south, int east, int center) {
      ...
      Biome edgeBiome = biome.getEdge(context, Registry.BIOME.getByValue(north), Registry.BIOME.getByValue(west), Registry.BIOME.getByValue(south), Registry.BIOME.getByValue(east));
      if (edgeBiome != null) return Registry.BIOME.getId(edgeBiome);
