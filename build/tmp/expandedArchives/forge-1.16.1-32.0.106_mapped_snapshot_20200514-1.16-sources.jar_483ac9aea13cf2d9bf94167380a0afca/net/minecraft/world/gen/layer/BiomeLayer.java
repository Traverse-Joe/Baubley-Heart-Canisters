...
public class BiomeLayer implements IC0Transformer {
   ...
   public int apply(INoiseRandom context, int value) {
      ...
      if (!LayerUtil.isOcean(value) && value != MUSHROOM_FIELDS) {
         ...
         case 1:
            ...
            return Registry.BIOME.getId(getWeightedBiomeEntry(net.minecraftforge.common.BiomeManager.BiomeType.DESERT, context));
         case 2:
            if (i > 0) {
               return JUNGLE;
            }

            return Registry.BIOME.getId(getWeightedBiomeEntry(net.minecraftforge.common.BiomeManager.BiomeType.WARM, context));
         case 3:
            if (i > 0) {
               return GIANT_TREE_TAIGA;
            }

            return Registry.BIOME.getId(getWeightedBiomeEntry(net.minecraftforge.common.BiomeManager.BiomeType.COOL, context));
         case 4:
            return Registry.BIOME.getId(getWeightedBiomeEntry(net.minecraftforge.common.BiomeManager.BiomeType.ICY, context));
         default:
   ...
   private net.minecraft.world.biome.Biome getWeightedBiomeEntry(net.minecraftforge.common.BiomeManager.BiomeType type, INoiseRandom context) {
      ...
      return net.minecraft.util.WeightedRandom.getRandomItem(biomeList, weight).biome;
   }
}